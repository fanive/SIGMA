      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
             ...
             _buildSectionTitle('PREVIEW: MID-DAY RESEARCH NOTE'),
             const SizedBox(height: 16),
             _buildRadarPost(
               isDark,
               'Preview content only. In production, this block should summarize observed market context, key sectors to review and volatility conditions from live data.',
               ['PREVIEW ONLY', 'LIVE DATA REQUIRED', 'NOT A TRADING SIGNAL'],
             ),
             const SizedBox(height: 24),
             _buildSectionTitle('MARKET MOVERS TO WATCH'),
             const SizedBox(height: 16),
